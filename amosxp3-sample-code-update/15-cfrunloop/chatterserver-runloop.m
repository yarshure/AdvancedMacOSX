...
// clang -g -Weverything -Wno-unused-parameter -framework Foundation -o chatterserver-runloop chatterserver-runloop.m
...
static void ReadUsername(ChatterUser *user) {
    ...
    if (user->bytesRead == 0) {
        ...
        ssize_t nread = read (user->fd, user->buffer + user->bytesRead, (size_t)nleft);
